...
import com.fmeng48.staybooking.model.BookingDto;
import com.fmeng48.staybooking.model.BookingEntity;
import com.fmeng48.staybooking.model.ListingEntity;
import com.fmeng48.staybooking.repository.BookingRepository;
...
/*
    public List<BookingDto> findBookingsByGuestId(long guestId){
        List<BookingEntity> bookingEntities = bookingRepository.findAllByGuestId(guestId);
        List<BookingDto> bookingDtos = new ArrayList<>();
        for (BookingEntity bookingEntity: BookingEntities){
            BookingDto booking = new BookingDto(bookingEntity);
